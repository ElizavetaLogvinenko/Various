...
(* ::Input:: *)
(*SetDirectory["/home/andrey/last_backup_0107/vct_pdms_edge"];*)
...
(* ::Input:: *)
(*newline={params[[3;;]],{F@(ComponentMeasurements[mCM,"Area"][[;;,2]]2.5^2),newline={params[[;;]],{F@(ComponentMeasurements[mCM,"Area"][[;;,2]]2.5^2),F[ComponentMeasurements[mCM,"ConvexCoverage"][[;;,2]]],F[(1-ComponentMeasurements[mCM,"CaliperElongation"][[;;,2]])^-1],N@F[legsCM],Total[Flatten@contsCM]/Ncm},{F@(ComponentMeasurements[mFB,"Area"][[;;,2]]2.5^2),F[ComponentMeasurements[mFB,"ConvexCoverage"][[;;,2]]],F[(1-ComponentMeasurements[mFB,"CaliperElongation"][[;;,2]])^-1],N@F[legsFB],Total[Flatten@contsFB]/Nfb},{0}};*)
(*F[(1-ComponentMeasurements[mFB,"CaliperElongation"][[;;,2]])^-1],N@F[legsFB],Total[Flatten@contsFB]/Nfb},{zeros}};*)
(**)
(*If[Position[FileNames[],"output.txt"]=={},newline>>"output.txt",out=<<"output.txt";*)
